...
export default function NavbarDefault() {
  ...
  const navList = (
    <ul className="nav-links mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a onClick={() => navigate("/users")} className="flex items-center">
          Users
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a onClick={() => navigate("/posts")} className="flex items-center">
          Posts
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a onClick={() => navigate("/faq")} className="flex items-center">
          FAQs
        </a>
      </Typography>
    </ul>
  ...
  return (
    <Navbar className="bg-[var(--navy-blue)] rounded-none px-4 py-2 lg:px-4 lg:py-4 w-full max-w-screen-full">
